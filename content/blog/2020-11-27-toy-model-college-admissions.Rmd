...
* The top-ranked college sorts its applicants by $\tilde{W}_i$ (descending) and admits the top students up to capacity $A_1$;

* The second-ranked college sorts its applicants by $\tilde{W}_i$ and admits all who were admitted by the first-ranked college, plus the top students who were not admitted by the first-ranked college, up to capacity $A_2$;
