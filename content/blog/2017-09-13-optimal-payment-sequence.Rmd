...
$$
(See [here](https://www.dropbox.com/s/x73wr3fxsxgdo1w/optimal-payment-sequence.pdf?raw=1) for a step-by-step derivation.) Assuming that $s_1$ is not too large so that the denominator is positive, $dR_1/dA_{1 \rightarrow j} \leq 0$ when the numerator is non-positive, i.e., when
$$
